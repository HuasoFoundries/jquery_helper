...
System.register("github:HuasoFoundries/systemjs-less-plugin@1.4.2.js!src/plugins/iconpicker.less", [], function() { return { setters: [], execute: function() {} } });

(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("src/plugins/jquery.iconpicker.js", ["npm:jquery@2.2.1.js", "github:lodash/lodash@3.10.1.js", "github:HuasoFoundries/systemjs-less-plugin@1.4.2.js!src/plugins/iconpicker.less"], function(jQuery, _) {
  _.templateSettings = {
    interpolate: /\{\{(.+?)\}\}/g,
    evaluate: /\{\{(.+?)\}\}/g,
    escape: /\{\{-(.+?)\}\}/g
