module.exports = function (grunt) {
	...
	fs.readdirSync(testsDir)
		...
		.forEach(function (testFilePath) {
			var taskName = "material_" + testFilePath.replace(/\.js$/, "");

			grunt.registerTask(taskName, function () {
				spawnTest(this.async(), "test/material_helper/" + testFilePath);
			});

			nodeSmokeTests.push(taskName);
		});

	grunt.registerTask("material_helper_smoke_tests", nodeSmokeTests);
};
