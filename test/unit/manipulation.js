...
function testAppend(valueObj, assert) {
	...
	assert.equal(jQuery("#select3").append(valueObj("<option value='appendTest'>Append Test</option>")).find("option:last-child").attr("value"), "appendTest",
...
QUnit.test("appendTo(String)", function (assert) {
	...
	assert.equal(jQuery("<option value='appendTest'>Append Test</option>").appendTo("#select3").parent().find("option:last-child").attr("value"), "appendTest",
		"Appending html options to select element");
...
QUnit.test("prepend(String)", function (assert) {
	...
	assert.equal(jQuery("#select3").prepend("<option value='prependTest'>Prepend Test</option>").find("option:first-child").attr("value"), "prependTest",
...
QUnit.test("prependTo(String)", function (assert) {
	...
	assert.equal(jQuery("<option value='prependTest'>Prepend Test</option>").prependTo("#select3").parent().find("option:first-child").attr("value"), "prependTest",
		"Prepending html options to select element");
...
QUnit.test("Empty replaceWith (trac-13401; trac-13596; gh-2204)", function (assert) {
	...
	jQuery.each(tests, function (label, input) {
		...
		$el.html("<i/>").children().replaceWith(function (i) {
			return input;
		});
...
QUnit.test("Ensure oldIE creates a new set on appendTo (#8894)", function (assert) {
	...
	assert.strictEqual(jQuery("<p/>").appendTo("<div/>").end().length, jQuery("<p>test</p>").appendTo("<div/>").end().length,
